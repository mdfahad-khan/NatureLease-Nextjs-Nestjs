...
const Shop = () => {
  ...
  return (
    <div className="container mx-auto mt-12 mb-20 w-[1100px]">
      <h2 className="text-3xl font-bold mb-3 text-center text-[#34495e]">
        Shop Here
      </h2>
      <div className="flex space-x-52 justify-between items-center mb-8">
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input
              ...
              className="w-64 h-8 px-4 border border-gray-300 rounded-full"
            />
        ...
        <button className="bg-[#36a089] hover:bg-blue-600 text-white font-[50px] py-2 px-4 rounded inline-flex items-center">
          <Link href="/Cart/Cart">
      ...
      <div className="grid  grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
        {Products.filter((product) => {
          ...
          <div
            key={product.id}
            className="hover:translate-y-[-3px] transition-transform"
          >
