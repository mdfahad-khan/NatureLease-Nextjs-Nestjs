  ...
  return (
    <div className="product max-h-[300px] flex items-start text-left">
      ...
      <div className="description leading-tight mt-0">
        ...
        <span className="text-[11px] mb-6 overflow-hidden whitespace-nowrap">
          {productDescription}
        </span>

        <div className="button w-[150px] flex  ">
          <button
            className="addToCartBtn1 text-[13px] mt-0 mb-0 w-[160px] h-6 flex items-center"
