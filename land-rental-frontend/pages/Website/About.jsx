...
const About = () => {
  return (
    <section
      ...
      id="about"
    >
      <div className="w-[340px] sm:w-[620px] md:w-[400px] lg:w-[550px] xl:w-[600px]   2xl:ml-[300px]  h-auto xl:h-[500px]  ml-[50px] pl-2 xl:mt-2">
        <h1
          className="text-[20px] xl:text-[40px] 
          2xl:text-[40px] sm:text-[23px] md:text-[27px] lg:text-[32px] text-center mt-2 xl:mt-20 duration-100 font-bold mb-2 text-[#3fbd88] "
        >
          About Us
        </h1>
        <div className="text-black duration-100 text-justify">
          ...
          <p className="text-[11px] sm:text-[13px] md:text-[14] lg:text-[16px] xl:text-[17px] 2xl:text-[20px]">
            ...
            At FarmConnect, innovation and sustainability are at the core of
            what we do. Our intuitive platform ensures seamless access to
            resources empowering.We are dedicated to ensuring your success in
            farming. Your needs and aspirations are our priority, and our
            passionate team is here to support you at every stage of your
            farming journey.
          </p>
        </div>
      </div>
      <div className="flex-shrink-0 w-[300px] xl:w-[500px] 2xl:w-[600px] mt-2 xl:ml-6 sm:ml-32 md:ml-10 lg:ml-12  mb-3 sm:mt-8 md:h-[300px] sm:w-[350px] sm:h-[200px] overflow-hidden   ml-8 ">
        <Image
